...
Creación de Objetos: Instanciar (crear) diferentes objetos que representen cada tipo de material (un Libro, una revista, etc...), inicializándolos con sus respectivos atributos (título, autor, ISBN, etc...).
